...
function RechercheReclamationC($haja){
  ...
  $sql="SELECT d.ID_R,d.OBJET_R,d.DETAILS_R,d.ETAT,d.NOW_R,u.nom,u.prenom FROM reclamation d INNER JOIN membres u ON u.cin=d.USER_ID WHERE NOW_R LIKE '%$haja%' ";
