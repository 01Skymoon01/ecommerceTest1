...
<!--            <a href="index.html"><img class="main-logo" src="img/lola.jpg" alt="" /></a>
        ...
        <div class="nalika-profile" style="" >
            <div class="profile-dtl">
                <a href="afficher_produits.php"><img class="main-logo" src="img/lola.jpg" alt="" /></a>
        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        <a class="has-arrow" href="product-edit.php" aria-expanded="false" ><i class="icon nalika-bar-chart icon-wrap"></i> <span
