...
-->
                       ...
                       <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                     <input class="input--style-1" type="password" placeholder="NOUVEAU MOT DE PASSE" name="mdp" id="mdp">
                                </div>
                            </div>
                        ...
                        <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" placeholder="NOUVEAU NUMERO DE TEL" name="num_tel" id="num_tel " >
                                </div>
                            </div>

                       
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" href="recuperation.php" onclick="Controle2();">Confirmer</button>                           
                        </div>
