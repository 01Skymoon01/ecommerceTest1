...
if ( prenom.length != 0) {
    ...
    {
        alert("Saisissez votre prenom svp!");
            return false ;
    }
...
var error= document.getElementById("labelCin");
...
if ( cin.length == 8) {
    ...
    error.innerHTML="CIN contient 8 chiffres.";
    return false;}
...
if (CheckPassword2() && CheckNom() && CheckPrenom() && CheckBd() && CheckMail() && CheckNum() && CheckCin()) {
