...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 17 Mai 2019 à 13:16
...
('chaise3', 1231564661, 125, 289, 'descr3', 'Interieur'),
...
--
ALTER TABLE `commande_details`
  MODIFY `id_CommandeDetails` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
--
...
--
ALTER TABLE `livraison`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4657579;
--
