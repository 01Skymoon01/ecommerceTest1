...
<script type="text/javascript">
    jQuery("body").prepend('<div id="ts-preloader-absolute"></div>');
    jQuery(document).ready(function() {
        jQuery("#ts-preloader-absolute").remove();
    });
</script>-->
<!--[if lt IE 8]>
            ...
            <div class="container-fluid">
                <fieldset style="margin-top:30px;border: #95C8D8;border-width: 5px;border-style: dashed;padding: 10px;">
                    <legend style="color: white; text-align: center;font-stretch: expanded"><h2><i class="icon nalika-edit" aria-hidden="true">
                            ...
                            </i>Ajouter Produit</h2>
                    </legend>
                <div class="row" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <div class="review-tab-pro-inner" style="height: 300px;">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                                ...
                                                <div class="review-content-section">
                                                    ...
                                                    <!--<div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               name="nprod" id="nprod" placeholder="Numero Produit"
                                                               onblur="verifnum(this)" required>
                                                    </div>-->
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd"
                                                                                           aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" id="PrixProd"
                                                               name="PrixProd" placeholder="Prix Produit"
                                ...
                                <br><br><br><br>
                                <div class="row" style="right: 300px;position: absolute;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="text-center custom-pro-edt-ds">
                                            <<button type="submit" id="sauvegarder" name="sauvegarder"
                                                     class="btn btn-sm waves-effect" style="background-color: #24caa1;position: absolute;right: 180px;"
                                                     onclick="return verifform()"><i class="fa fa-check-circle fa-2x"></i>
                                            </button>
                                            <button type="button" style="background-color: #E8DDB0;position: absolute;right: 130px;"
