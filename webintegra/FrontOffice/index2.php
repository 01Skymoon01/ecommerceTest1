		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 col-xs-2">
					<div id="fh5co-logo"><a href="index.php"><img src="images/logosn.png" alt="" width="35" style="margin: -4px 5px 0px 10px;" />GEOCONCEPT</a></div>
                            ...
                            if (!empty($userinfo['avatar'])) {
                                ?>
                            <div style="margin-right: 300px;"><center><a href="profile.php"><img src="membres/avatars/<?php echo $userinfo['avatar'];?>" style="padding-left: 35%;" width="200" height="200"/></a></center></div>
                            <?php                            
                            }
                            else {
                                ?>
                ...
                <div class="input-group" style="padding-left: 50px;"> 
                    	<?php if(!empty($_SESSION)) { ?><a href="logout.php" class="deja2" style="color: #888;">Log out</a></div><?php }?>
				</div>
				...
				<div class="col-md-6 col-xs-6 text-center menu-1">
					<ul>
						...
						<?php if(empty($_SESSION)) { ?><li><a href="signup.php">S'inscrire</a></li> 
