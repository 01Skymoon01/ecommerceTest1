...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 09 Mai 2019 à 10:37
...
(77, 55442233, '2019-05-07 06:33:37', 125, 1, 1, 1),
...
(112, 77, 'chaise3', 1231564661, 1, 125),
...
(88914, '2019-04-30', 'etryj', 20158158, 'partenariat', 'ghj', 'en attente', 66666666),
...
(51, 66666666, 'chaise125', 1231564660, 500);
...
(124, 'jam', 75, 11653236, 'Rue Chimie', NULL),
(125, 'jam', 75, 11653236, 'Rue Chimie', NULL),
(126, 'jam', 75, 11653236, 'Rue Chimie', NULL),
(127, 'libya', 76, 11653236, 'Rue Chimie', NULL),
(128, 'libya', 76, 11653236, 'Rue Chimie', NULL),
...
(12345678, 'mehdi', 'hmaidi', '23584248', 'elmehdihmaidi@gmail.com', 'bardo', 0, NULL),
(11653236, 'mehdi', 'mehhd', '23584248', 'mehdi@gmail.com', 'tunis', 1, '0,5'),
(66666666, 'nour', 'nour', '95164507', 'gonklovox@gmail.com', 'arianaaa', 0, '2');
...
(6, 123546, '2019-05-06 12:23:49', 50000, 100, 1),
(7, 123546, '2019-05-06 12:24:37', 100000, 200, 1),
(8, 123546, '2019-05-06 13:28:04', 51000, 102, 0),
...
(25689745, 'nour', 'gonklovox22@gmail.com', 'c64d32f9f56f83e817e7e4f115085c5f', '2019-05-02', 'Femme', 95164507, 'nour', ''),
...
(66666664, 'rygz''syhryrh', 'gonklgsdox@gmail.com', '25d55ad283aa400af464c76d713c07ad', '2019-04-27', 'Femme', 95164507, 'hedrhjeruju', ''),
...
('chaise125', 1231564660, 500, 116, 'descrchaise125', 'Exterieur'),
('chaise3', 1231564661, 125, 290, 'descr3', 'Interieur'),
('Fauteuil', 1231564663, 550, 43, 'Fauteuil Comfort', 'Interieur'),
...
--
ALTER TABLE `commande_details`
  MODIFY `id_CommandeDetails` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
--
...
--
ALTER TABLE `livraison`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4657576;
--
-- AUTO_INCREMENT pour la table `loc`
--
ALTER TABLE `loc`
  MODIFY `idloc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `rdv`
  MODIFY `ID_RDV` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
