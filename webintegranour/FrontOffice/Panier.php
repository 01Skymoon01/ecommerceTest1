...
<form method="POST" action="addCommande.php">
	<div id="fh5co-started">
			...
			<div class="well well-small" style="margin-left:20% ; width:900px ;min-height: 400px;padding: 50px;">
...
<tbody class="cart-item">
    ...
    <?php                     }
			...
			<a href="<?php echo $_SESSION["page"]; ?>" class="shopBtn btn-large"><span class="icon-arrow-left"></span> Continue Shopping </a>
                ...
                <button type="submit" id="submit" class="btn btn-primary pull-right btn-sm" name="ajouter"  style="margin-left: 35%;margin-top: -1%;"><i class="icon-check2 icon"></i>Acheter</button>
		</div>
