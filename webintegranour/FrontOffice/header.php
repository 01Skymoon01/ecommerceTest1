...
<head>
    ...
    <meta name="description" content="Ventes Meubles GeoConcept" />
    <meta name="keywords" content="Meubles, Intérieurs, Extérieurs, Tunisie, Ecommerce, Location, Livraison, rapide, Mobilier , chaise , lit , table " />
    <meta name="author" content="Geoconcept" />
...
<body>
  ...
  <?php if($_SESSION["page"]!="GameGeo.php" ){?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-xs-2">
                    <div id="fh5co-logo"><a href="index.php" onmouseout="this.style.color='black'" onmouseover="this.style.color='#d1c286'" style="font-size: 28px;position: absolute;right: 190px;">GeoConcept.</a></div>
                </div>
                    ...
                    <div class=" btn btn-group">
                        <ul style="margin: auto">
                            ...
                            <?php if(isset($_SESSION['cin'])){ ?>
                                ...
                                <li class="has-dropdown">
                                    <a data-toggle="tooltip" title="Favoris" href="addfavoris.php" style="font-size: x-large;"><i class="fa fa-star fa-spin"></i></a>
                                    <ul class="dropdown">
                                        <li><a href="addfavoris.php">Favoris</a></li>
                                    </ul>
                                </li>
                                <li class="has-dropdown">
                                    <a href="afficherCommentaires.php" style="font-size: x-large;"><i class="fa fa-comment"></i></a>
                                    <ul class="dropdown">
                                        <li><a href="afficherCommentaires.php">Commentaires</a></li>
                                    </ul>
                                </li>
                            ...
                            <?php } ?>
                            <li class="has-dropdown">
                                <a href="../Views/index.php" class="icon-swap" style="font-size: x-large;"></a>
                                <ul class="dropdown">
                                    <li><a href="../Views/Afficher_admins.php">Back-Office</a></li>
                                </ul>
                            </li>
                                    ...
                                    <div style="margin-left:80px; ">
                                        ...
                                        if (!empty($userinfo['avatar'])) {
                                            ...
                                            <ul class="dropdown" style="margin-left:80px; width:80px;">
                                                ...
                                                <li><a href="GameGeoUpload.php" class="deja2">Gerer Geo</a></li>
