        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 animate-box">
                    <h3>Modifier Vos Demandes</h3>
                    <form method="post" action="modif.php">
                        <input type="hidden" id="user" name="user" value="<?php echo $id;?>">
                        <div class="row form-group">
                            <div class="col-md-6">
                                 <label for="lname">Nom du groupe</label>
                                <input type="text" id="lname" name="lname" class="form-control" placeholder="Nom" value="<?php echo $nom;?>">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input type="number" id="num" name="num" class="form-control" placeholder="Votre numéro: +216" value="<?php echo $num;?>">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input type="text" id="details" name="details" class="form-control" value="<?php echo $details;?>">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-12">
