        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 animate-box">
                    <h3>Modifier Vos Rendez-Vous</h3>
                    <form method="post" action="modifRDV.php">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input type="date" id="date" name="date" placeholder="YYYY-MM-DD" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" title="Enter a date in this formart YYYY-MM-DD" value="<?php echo $date;?> />
                            </div>
                        </div>
