...
<div class="product-status mg-b-30" style="margin-top:50px; margin-left:2px">
    ...
    <div style="display: flex;">
                                  ...
                                  foreach ($list as $row)
                                    {
                                        ...
                                        */
                                        echo '<td class="td2">'?> <button class="btn btn--radius btn--red" type="submit" nom="supprimer"
                                            style="color:black; background: none; " onclick="location.href='supprimerUsers.php?cin=<?php echo $row['cin']; ?>&prenom=<?php echo $row['prenom']; ?>'"> <img src="img/trash.png" style="height: 30px; width: 30px;"> </button><?php '</td>';
                                        echo '</tr>';
                                    }
                                 ?>
                            ...
                            <div class="custom-pagination">
								<ul class="pagination">
									<li class="page-item"><a class="page-link" href="Users.php">Retour</a></li>
