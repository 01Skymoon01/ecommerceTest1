                                ...
                                <div class="breadcomb-report">
                                    ...
                                    <div class="breadcome-heading" style="margin-left: 40%;">
                                        <form role="search" class="">
                                            <input data-toggle="tooltip" title="Recherche Nom/Mail" id="myInput" style="color:white;"  type="text" placeholder="..."  onkeyup="myFunction()" class="form-control">
                                        </form>
                                    </div>
                                    <a data-toggle="tooltip" title="Telecharger PDF" href="TelechargerListe.php" class="fa fa-download fa-2x " target="_blank">
