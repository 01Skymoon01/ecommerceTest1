    ...
    <div class="single-product-tab-area mg-b-30" style="margin-top:10px;">
        ...
        <div class="single-pro-review-area">
            <div class="container-fluid">
                    ...
                    <fieldset style="margin-top:30px;border: #5E6089;border-width: 5px;border-style: dashed;padding: 10px;">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="review-tab-pro-inner">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit" style="text-align: center;">

                                <form method="post" action="ajouter_admin.php" style="text-align: center;">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-left: 250px;margin-bottom: 20px;margin-top: auto;">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt" style="text-align: center;">
                                                        <!--<span class="input-group-addon"><i class="icon nalika-user"
                                                                                           aria-hidden="true"></i></span>

                                                        <input type="text" class="form-control" name="idadmin"
                                                               id="idadmin" placeholder="ID.."
                                                               onblur="verifnum(this)">-->
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt" style="text-align: center;">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <button type="submit" id="sauvegarder" name="sauvegarder"
                                                            ...
                                                            onclick="return verifformAdmin()"><i class="fa fa-check-circle fa-2x"></i>
                                                    </button>
                                                    <button type="button" style="background-color: #E8DDB0;"
                                                            class="btn btn-sm"><i class="fa fa-times-circle"></i>
                                                    </button>
                                                </div>
