...
$listeProd=$produitC->rechercherProduit($_POST['search']);
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        ...
                                        <p>Recherche Produits<span class="bread-ntd"> GeoConcept.</span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap">
                        ...
                        <table class="table-bordered" style="background-color: midnightblue">
                            <tr>
                            ...
                            foreach($listeProd as $row){
                                ...
                                <tr>
                                    ...
                                    <td><form method="POST" action="supprimer_produit.php">
                                            <input type="submit" name="supprimer" class="btn btn-ctl-bt waves-effect waves-light m-r-10" value="supprimer">
                                            <input type="hidden" value="<?PHP echo $row['num']; ?>" name="num">
                                        </form>
                                    </td>
                                    <td><button class="btn btn-default btn-sm"><i class="fa fa-edit"><a href="Page_Update.php?numprod=<?PHP echo $row['num'];?>&amp;nomprod=<?PHP echo $row['nom'];?>&amp;prix=<?PHP echo $row['prix'];?>&amp;qte=<?PHP echo $row['qte'];?>&amp;descr=<?PHP echo $row['descr'];?>&amp;cat=<?PHP echo $row['cat'];?>">Modifier</a></td>
                                    </i></button>
                                    <td>
