                                ...
                                <?php
                                     foreach ($ListetooC as $row)
                                    {
                                        ...
                                        echo '<td class="td2">'?> <button class="btn btn--radius btn--red" type="submit" nom="supprimer"
                                            style="color:black; background: none; " onclick="location.href='supprimerUsers.php?cin=<?php echo $row['cin']; ?>&prenom=<?php echo $row['prenom']; ?>'"> <img src="img/trash2.png" style="height: 25px; width: 25px;"> </button><?php '</td>';
