    ...
    <div class="box dark">
      ...
      <div id="div-1" class="accordion-body collapse in body" >
        <form action="sendmailtosubs.php" method="post" class="form-horizontal" data-parsley-validate>
          ...
          <div class="form-group">
            <div>
              <center><button class="btn btn-lg btn-success" type="submit" name="envoi" style="background-color: #365D84; border:none; margin-left: 114%; margin-top: 10px; "><i class="fa fa-envelope"></i> Send</button></center>
